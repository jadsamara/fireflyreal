...
export const Footer = ({ updatedLocation, navigation, spark }) => {
  ...
  const onHandleConfirmArrival = () => {
    navigation.navigate("InitialArrivedPage", {
      spark: spark,
    });
  };
  ...
  return (
    <Container>
      <FirstRow>
        ...
        <HeaderText>You're Here!</HeaderText>

        <ConfirmArrivalButton onPress={onHandleConfirmArrival}>
          <ConfirmArrivalText>Continue</ConfirmArrivalText>
      ...
      <LastRow>
        ...
        <ProfilePicturesContainer>
          {updatedLocation &&
            ...
            updatedLocation.Array.length > 0 &&
...
const Container = styled(View)`
  position: absolute;
  background-color: rgba(121, 209, 124, 0.7);
  z-index: 99999;
  bottom: 0px;
  width: 100%;
  height: 200px;
...
const ConfirmArrivalButton = styled(TouchableOpacity)`
  width: 130px;
  height: 30px;
...
const ConfirmArrivalText = styled(Text)`
  color: white;
