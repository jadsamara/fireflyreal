...
export const BodyComponent = ({ spark, userInfo }) => {
  ...
  if (userInfo.hasOwnProperty("age")) {
    formattedAge = calculateAge(userInfo.age);
  }

  return (
    <Container>
      <HostInfoText>
        {userInfo.name}, {formattedAge}
      </HostInfoText>
      <RatingsContainer>
        ...
        <TotalSparksText>
          {userInfo.pastSparks ? userInfo.pastSparks.length : null} sparks
        </TotalSparksText>
      </RatingsContainer>
