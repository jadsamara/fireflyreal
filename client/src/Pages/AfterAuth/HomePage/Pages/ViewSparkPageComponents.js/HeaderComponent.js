...
export const HeaderComponent = ({ spark, navigation }) => {
  ...
  if (spark.chosenTime) {
    ...
    formattedDateText = "confirmed";
  } else {
    formattedDate = "Request available dates";
    formattedDateText = "flexible";
  }
  ...
  return (
    <SparkHeaderContainer>
      ...
      <DynamicBar>
        <DynamicBarText>This spark is {formattedDateText}</DynamicBarText>
        <ProfilePictureHost
          source={{
