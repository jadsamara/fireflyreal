...
export const SparkCardActive = ({ spark = {}, navigation }) => {
  ...
  return (
    <Container>
        ...
        <ParticipantsAndGroupContainer>
          ...
          <RequestChatCol>
            {spark.host === userNumber ? (
              ...
              <ViewAcceptedButton>
                <ViewRequestsText>Accepted</ViewRequestsText>
              </ViewAcceptedButton>
            )}
      ...
      <SparkStatusContainer>
        <SparkStatusText>Live</SparkStatusText>
      </SparkStatusContainer>
      <LineBreak />
    </Container>
  );
...
const ViewAcceptedButton = styled(View)`
  background-color: #415f74;
  padding-top: 7px;
  padding-bottom: 7px;
  padding-left: 15px;
